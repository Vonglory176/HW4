...
function mostBurnedButtonClick() {
    try {
        ...
        document.getElementById("calorieOutput").value = workoutArray[winningIndex].exercise + " " + workoutArray[winningIndex].calories
    } catch { alert("Error!! No exercise information has been entered! ") }
}
